...
open class FSPagerViewTransformer: NSObject {
    ...
    @objc open var minimumScale: CGFloat = 0.75
    @objc open var minimumAlpha: CGFloat = 0.75
    ...
    open func proposedInteritemSpacing() -> CGFloat {
        ...
        case .linear:
            ...
            return 100//pagerView.itemSize.width * -self.minimumScale * 0.2
        case .coverFlow:
            guard scrollDirection == .horizontal else {
                return 100
            }
            return 100//-pagerView.itemSize.width * sin(.pi*0.25*0.25*3.0)
        case .ferrisWheel,.invertedFerrisWheel:
            guard scrollDirection == .horizontal else {
                return 100
            }
            return 100//-pagerView.itemSize.width * 0.15
        case .cubic:
            return 100
        default:
            break
        }
        return 100//pagerView.interitemSpacing
    }
